...
const AXIS_WIDTH = 4
/**@type {string} 轴颜色*/
const AXIS_STROKE_STYLE = '#f1c971'
/**@type {string} */
const AXIS_STROKE_STYLE_HOVER = '#f1c971'
...
/**@type {string} 刻度颜色*/
const TICK_STROKE_STYLE = '#f1c971'
...
/**@type {string} 游标颜色*/
const CURSOR_FILL_STYLE = 'rgba(241, 201, 113, 1)'
/**@type {string} 游标hover颜色*/
const CURSOR_HOVER_FILL_STYLE = 'rgba(241, 201, 113, 1)'
